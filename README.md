...
| Agent Island        | Native macOS and Windows companion showing live session state, quota, and cost for Claude Code, Codex, Antigravity, Grok, and Cursor. | [Link](https://github.com/tristan666666/agent-island) |
